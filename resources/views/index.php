					...
					<div class="inner">
						...
						<div class="form-content">
							...
							<div class="form-row">
								...
								<div class="form-holder">
									<input type="text" placeholder="Numero Telephone" class="form-control">
								</div>
							</div>
							<div class="form-row">
								<div class="form-holder">
						...
						<div class="form-content">
							...
							<div class="form-row">
								<div class="form-holder">
									...
									<input id="file-upload" type="file" class="form-control1" multiple>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="form-content">
							...
							<div class="payment-container">
								...
								<div id="payment-options" class="payment-options">
									<button class="payment-option" data-method="Carte de Crédit">
										<img src="{{ asset('images/credit-card.png') }}" alt="Carte de Crédit"
											class="payment-logo">Carte de Crédit
									</button>
									<button class="payment-option" data-method="PayPal">
										<img src="{{ asset('images/paypal.png') }}" alt="PayPal"
											class="payment-logo">PayPal
									</button>
									<button class="payment-option" data-method="Virement Bancaire">
										<img src="{{ asset('images/bank-transfer.png') }}" alt="Virement Bancaire"
											class="payment-logo">Virement Bancaire
									</button>
								</div>
							</div>
							<div>
