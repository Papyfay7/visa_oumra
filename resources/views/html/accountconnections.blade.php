                    ...
                    <ul class="nav nav-pills flex-column flex-md-row mb-6">
                      <li class="nav-item">
                        <a class="nav-link" href="{{url('account')}}"
                          ><i class="bx bx-user bx-sm me-1_5"></i> Account</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="pages-account-settings-notifications.html"
                          ><i class="bx bx-bell bx-sm me-1_5"></i> Notifications</a
                        >
                      </li>
                      <li class="nav-item">
                        ...
                        <div class="card-body">
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img src="images/icons/brands/google.png" alt="google" class="me-4" height="32" />
                            </div>
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img src="images/icons/brands/slack.png" alt="slack" class="me-4" height="32" />
                            </div>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                              <div class="mb-sm-0 mb-2">
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img src="images/icons/brands/github.png" alt="github" class="me-4" height="32" />
                            </div>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                              <div class="mb-sm-0 mb-2">
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="images/icons/brands/mailchimp.png"
                                alt="mailchimp"
                                class="me-4"
                                height="32" />
                            </div>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img src="images/icons/brands/asana.png" alt="asana" class="me-4" height="32" />
                            </div>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                              <div class="mb-sm-0 mb-2">
                      ...
                      <div class="col-md-6 col-12">
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="images/icons/brands/facebook.png"
                                alt="facebook"
                                class="me-4"
                                height="32" />
                            </div>
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="images/icons/brands/twitter.png"
                                alt="twitter"
                                class="me-4"
                                height="32" />
                            </div>
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="images/icons/brands/instagram.png"
                                alt="instagram"
                                class="me-4"
                                height="32" />
                            </div>
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="images/icons/brands/dribbble.png"
                                alt="dribbble"
                                class="me-4"
                                height="32" />
                            </div>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="images/icons/brands/behance.png"
                                alt="behance"
                                class="me-4"
                                height="32" />
                            </div>
              ...
              <div class="container-xxl">
                <div
                  ...
                  <div class="text-body">
                    ...
                    , made with ❤️ by
                    <a href="" target="_blank" class="footer-link">Innopeaksn</a>
                  </div>
