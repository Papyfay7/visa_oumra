                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive text-nowrap">
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @foreach (json_decode($registration->documents) as $document)
                                            <a href="{{ asset('storage/' . $document) }}" target="_blank">View</a><br>
                                            @endforeach
                                            @endif
                                            @endif
                            ...
                            <!-- Pagination and Display Information -->
                            <div class="pagination-container">
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <div class="align-self-center">
                                        <p>Affichage de {{ $registrations->firstItem() }} à {{ $registrations->lastItem() }} sur {{ $registrations->total() }} entrées</p>
                                    </div>
                                    <!-- Pagination Links -->
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            @for ($i = 1; $i <= $registrations->lastPage(); $i++)
                                                <li class="page-item {{ $registrations->currentPage() == $i ? 'active' : '' }}">
                                                    <a class="page-link" href="{{ $registrations->url($i) }}">{{ $i }}</a>
                                                </li>
                                                @endfor
                                                ...
                                                <li class="page-item {{ !$registrations->hasMorePages() ? 'disabled' : '' }}">
                                                    <a class="page-link" href="{{ $registrations->url($registrations->lastPage()) }}">
